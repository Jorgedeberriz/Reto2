...
INSERT INTO `cuenta` (`dtype`, `id`, `comision`, `fecha_creacion`, `interes`, `saldo`) VALUES
('Ahorro', 1, 0.2, '2023-11-07', 1.1, 100),
('Corriente', 2, 0.2, '2023-11-07', 0.5, 200),
('Ahorro', 3, 0.2, '2023-11-07', 1.1, 300),
('Ahorro', 4, 0.2, '2023-11-07', 1.1, 300);
